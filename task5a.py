...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        for iteration in range(training_iterations):
            ...
            if(iteration != 1 and (iteration + 1) % lr_decay_iter == 0): 
                curr_learning_rate = curr_learning_rate/2 # Divide learning rate by 2 every 450 iters
                print("Iter num is: " + str(iteration))
                print("lr is: " + str(curr_learning_rate))
